...
function evalNode(node, ctx, opts) {
  switch (node.kind) {
    ...
    case "number":
      return new import_decimal.default(node.value);
    case "string":
      return node.value;
    case "boolean":
      return node.value;
...
function toDecimal(value) {
  if (value instanceof import_decimal.default) return value;
  if (typeof value === "boolean") throw new DsqlexError("Cannot convert boolean to Decimal");
  if (typeof value === "number") return new import_decimal.default(value);
...
function roundDecimal(value, precision) {
  return value.toDecimalPlaces(precision, import_decimal.default.ROUND_HALF_UP);
}
function compare(a, b) {
  if (a === null && b === null) return "eq";
  if (a === null || b === null) return "neq";
  if (a instanceof import_decimal.default || b instanceof import_decimal.default) {
    try {
...
function isDecimalLike(value) {
  if (value instanceof import_decimal.default) return true;
  if (typeof value === "number" && typeof value !== "boolean") return true;
  if (typeof value === "string") {
    try {
      new import_decimal.default(value);
      return true;
    } catch {
      return false;
    }
